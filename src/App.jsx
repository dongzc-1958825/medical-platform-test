...
function Home() {
  return (
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <p><strong>当前方案：</strong>HashRouter模式</p>
      ...
      <div style={{ border: '2px solid #007acc', padding: '20px', borderRadius: '8px' }}>
        <h2>🚀 路由测试区域</h2>
        <Routes>
          <Route path="/" element={<div>🎉 <strong>欢迎来到首页！</strong><br/>HashRouter模式测试。</div>} />
          <Route path="/about" element={<div>📖 <strong>关于页面</strong><br/>HashRouter应该解决刷新问题。</div>} />
